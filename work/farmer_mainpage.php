...
<header>	
	...
	<table>
	<tr><td>
     <a href="propose_price.php" class="btn btn-one" >PROPOSE PRICE</a></td>
     <td><a href="accepted_crops.php" class="btn btn-two">ACCEPTED CROPS</a></td>
     <td><a href="loans_taken.php" class="btn btn-four">LOANS</a></td></tr>
	 </table>
	 </center>
  </div>
</div>
