...
<header>	
	...
	<ul class="main-nav">
		...
		<div class="hero1"><center><font size="7px" color="#F2E3E3">LOANS TAKEN</font></center>
	    <br/>
		...
		echo '<tr>
			...
			echo '<div style="padding-top:10%"><b><center>NO RECORD FOUND</b></center></div>';
    ...
    <b><center><a href="apply_loans"><h2 class="color">Click here to apply loan!</h2></a></center></b>
