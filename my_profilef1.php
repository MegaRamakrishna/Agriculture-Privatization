...
<header>	
	...
	<?php 
		...
		<td class="tdd1">:</td>
		<td class="tdd12"><input type="number" name="f_id" disabled value="'.$m['f_id'].'"></td>
	    </tr>
		...
		<td class="tdd1">:</td>
		<td class="tdd12"><input type="text" name="f_name" value="'.$m['f_name'].'"></td>
	    </tr>
		...
		<td class="tdd1">:</td>
		<td class="tdd12"><input type="date" name="dateofbirth" value="'.$m['dateofbirth'].'"></td>
	    </tr>
		...
		<tr>
		<td class="tdd1">PINCODE*</td>
		<td class="tdd1">:</td>
		<td class="tdd12"><input type="number" name="r_id" value="'.$m['r_id'].'"></td>
		</tr>
		...
		<td class="tdd1">:</td>
		<td class="tdd12"><input type="password" name="passwordf" placeholder="ENTER NEW PASSWORD" ></td>
		</tr>
